...
class TestConfigDefaultsStructure:
    ...
    def test_expected_parameter_count(self):
        assert len(CONFIG_DEFAULTS) == 172  # 113 Phase 2 + 33 Phase 3 + 6 audit + 20 Phase 4 I&W
    ...
    def test_iw_config_entries(self):
        ...
        expected_keys = {
            ...
            "iw.min_discovery_confidence",
            "iw.min_match_ratio",
            "iw.min_observations_seed",
            "iw.min_observations_emerging",
            "iw.min_consistency_emerging",
            "iw.min_observations_confirmed",
            "iw.min_consistency_confirmed",
            "iw.min_observations_mature",
            "iw.min_consistency_mature",
            "iw.min_density_emerging",
            "iw.min_density_confirmed",
            "iw.dormant_days",
            "iw.retired_days",
            "iw.max_composites",
            "iw.backtest_days",
            "iw.backtest_holdout_ratio",
            "iw.backtest_min_f1",
            "iw.detector_window_seconds",
